package DrShadow.TechXProject.items.inventory;
...
public class ItemInventory implements IInventory
{
	...
	public void readFromStack(ItemStack masterStack)
	{
		if (masterStack != null)
		{
			if (masterStack.getTagCompound() == null) masterStack.setTagCompound(new NBTTagCompound());

			NBTTagCompound tag = masterStack.getTagCompound();
			readFromNBT(tag.getCompoundTag("Inventory"));
		}
	}
