...
public class BlockItemOutputConduit extends BlockContainerBase
{
	private static final PropertyDirection direction = PropertyDirection.create("rotation");

	public BlockItemOutputConduit()
	{
