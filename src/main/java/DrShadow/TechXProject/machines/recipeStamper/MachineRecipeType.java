...
public enum MachineRecipeType implements Serializable
{
	...
	SMELTER(new ItemStack(InitBlocks.smelter.block), InitBlocks.smelter.block.getLocalizedName(), "Smelts Rocks, Metals and other Things.", new ItemStack(Blocks.furnace), new ItemStack(Blocks.iron_block), new ItemStack(Blocks.iron_block), new ItemStack(Blocks.nether_brick), new ItemStack(Blocks.nether_brick)),
